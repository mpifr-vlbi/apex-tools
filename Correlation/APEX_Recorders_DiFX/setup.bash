...
export PGPLOTDIR=/opt/pgplot
export IPPROOT=/opt/intel

export DIFX_MACHINES=/usr/local/difx/share/machinesfile
...
export DIFX_MPIRUNOPTIONS="--bynode --mca mpi_yield_when_idle 1 --mca rmaps seq  --mca btl_tcp_if_include eth1"
