...
#define TONE_FREQ_MHZ    500     /* Baseband tone freq in MHz; APEX: 426 MHz, Kitt Peak: 500 MHz? */
#define LO_OFFSET_HZ     -15.022 /* Offset of 1st LO to compensate for */
#define HAVE_LO_OFFSET   0       /* 1: LO offset present and should be removed, 0: disable removal of LO offset; APEX 1, Kitt Peak 0 */
