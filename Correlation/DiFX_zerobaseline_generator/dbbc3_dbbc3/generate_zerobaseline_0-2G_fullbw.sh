...
if [ "$1" == "" ] || [ "$3" == "" ]; then
	...
	echo "Usage: generate_zerobaseline_0-2G_fullbw.sh <dbbc3_vdiffile1> <dbbc3_vdiffile2> <jobname>"
	echo
	echo "Produces:"
	...
	sed "s/2017y000d00h00m00s/$vexfmt/g" generate_zerobaseline_0-2G_fullbw.template > ${3}.vex
	cp -a generate_zerobaseline_0-2G_fullbw.v2d_template ${3}.v2d
