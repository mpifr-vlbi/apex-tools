...
* 
*  VLBI equipment
mk4     type of rack (mk3, vlba, vlbag, mk4, vlba4,
...
*vlba4   type of recorder 1 (mk3, vlba, vlba2, vlbab, vlba4, vlba42, mk4,
*mk5a_bs  type of recorder 1 (mk3, vlba, vlba2, vlbab, vlba4, vlba42, mk4,
*                            mk4b, s2, k41, k41/dms, k42, k42/dms, mk5a,
*                            mk5a_bs, or none)
mk5a_bs
none     type of recorder 2 (mk3, vlba, vlba2, vlbab, vlba4, vba42, mk4,
*                            mk4b, or none)
mk4     type of decoder (mk3, dqa, mk4, or none)
equipment mk4 mk5a none
equipment_override
*
* Mark III/IV rack parameters
 500.10 IF3 LO Frequency
   0    hex mask indicating which IF3 switches are installed, sw N ~ 2^(N-1)
*
...
* LBA/4 rack parameters
   0    No of LBA DAS installed (up to MAX_DAS - see "params.h")
