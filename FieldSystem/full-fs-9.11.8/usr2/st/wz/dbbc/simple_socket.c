...
unsigned int uiSend (SimpleSocketType * SSocket, char * pcBuffer, unsigned long ulBufferLength)
{
    ...
    {
if (DEBUG) printf ("simple_socket uiSend: buffer:%s len:%d\n", pcBuffer, ulBufferLength);
...
if (DEBUG) printf ("UDP\n");
            ...
            else
            {
                ...
                {
if (DEBUG) printf ("simple_socket TCP: OPEN\n");
                ...
                {
if (DEBUG) printf ("simple_socket TCP CLOSE\n");
