...
$scale=1.3; $xoff=-0; $yoff=-5; $fontsize=10;
...
while(<fi>){
  ...
  if($ss[2] eq "moveto"){
     ...
     if($done_prolog == 0){
	  ...
	  print (fo "% EPSF in style of ps2eps \n");
	  print (fo "%%BeginProlog\n");
	  print (fo "save\n");
	  print (fo "countdictstack\n");
	  print (fo "mark\n");
	  print (fo "newpath\n");
	  print (fo "/showpage {} def\n");
	  print (fo "/setpagedevice {pop} def\n");
	  print (fo "%%EndProlog\n");
	  print (fo "%%Page 1 1\n");
