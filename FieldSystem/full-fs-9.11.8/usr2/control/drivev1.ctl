...
1400    vacuum current offset (counts)
100     vacuum current scale  (counts/in)
...
14.0    write voltage (V) (stack 1 for vlba4, for thin tape if switching)
...
14.0    thick tape write voltage (V) (stack 1 for vlba4)
* VLBA4 parameters
