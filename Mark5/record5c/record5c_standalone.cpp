...
//
// $Id: record5c.cpp 4142 2011-12-13 06:22:31Z WalterBrisken $
// $HeadURL: https://svn.atnf.csiro.au/difx/applications/mk5daemon/trunk/mk5dir/record5c.cpp $
// $LastChangedRevision: 4142 $
// $Author: WalterBrisken $
// $LastChangedDate: 2011-12-13 07:22:31 +0100 (Tue, 13 Dec 2011) $
//
//============================================================================
...
#if 1
// DUMMY for standalone operation
#define DIFX_MESSAGE_MAX_SCANNAME_LEN MODULE_SCAN_NAME_LENGTH
typedef struct DifxMessageMk5Status_t {
   char vsnA[128];
   char vsnB[128];
...
void difxMessageSendMark5Status(DifxMessageMk5Status* m)
{
   return;
}
void difxMessageInit(int, const char*)
{
   return;
}
#endif
...
// JanW
	...
	WATCHDOGTEST( XLRWriteDBReg32(xlrDevice, FILL_PATTERN_ADDR, 0xDEADBEEF) );
