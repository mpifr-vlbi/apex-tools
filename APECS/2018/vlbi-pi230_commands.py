...
def vlbi_tp_onsource_v1(src='M87', t_mins=4):
    '''Total power monitoring for VLBI, taken while tracking source.
    
       t_mins : integration time in MINUTES.
    '''
...
def vlbi_tp_onsource_prepare_v2(src='M87'):
    execfile('pi230_setup.apecs')
    source(src)
    # Try this...JPE @ 2018-04-19
    tp()
...
def vlbi_tp_onsource_v2(src='M87', t_mins=4):
    '''Total power monitoring for VLBI, taken while tracking source.
...
# -------------------- version 2, JPs recommended changes, taken into account in version 3 further below ---------------------------

# Recommendation by JP:
...
# Example function by JP
def vlbi_tp_onsource_V2_JP(src='M87', t_mins=4):
    '''Total power monitoring for VLBI, taken while tracking source.
...
# -------------------- version 3 accounting for JPs suggestions ---------------------------

def vlbi_reference_scan():
    '''
    Take an on() scan with duration of ~1 minute with an off-source reference.
