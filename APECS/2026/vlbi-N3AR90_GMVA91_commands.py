...
def vlbi_tone(enable=False, freq_mhz=17219.0, pow_dbm=0, scpi_url="http://10.0.6.66/scpi", simulate=False):
	# dummy
	print('vlbi-N3AR90_GMVA91_commands.py : vlbi_tone() implementation todo')
