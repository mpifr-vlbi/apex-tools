...
/etc/r2dbe/R2DBE_config.py --ifaces eth3,eth5 --stationIDs AR,ar --src 192.168.1.13,192.168.1.15 --dst 192.168.1.3,192.168.1.5 --arp 3,0060dd440b75 --arp 5,0060dd4446c0 --pols 0,0 r2dbe-1
