...
if args.file is not None:
    ...
    if rcp.read(args.file):
        ...
        for sec in ['if0','if1']:
            for key in ['station_id','pol','bdc_sideband','rec_sideband','thread_id']:
                try:
...
thread_id_0 = int(config['if0']['thread_id'])
thread_id_1 = int(config['if1']['thread_id'])
...
if args.verbose > 0:
    ...
    print "thread_id={0}".format(thread_id_0)
    ...
    print "thread_id={0}".format(thread_id_1)
